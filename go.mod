...
require (
	...
	github.com/openshift/jobset-operator v0.0.0-20260711072835-3e31beea6ad3
	github.com/openshift/library-go v0.0.0-20260715193157-1a5091f58ece
	github.com/openshift/lws-operator v0.0.0-20260713164836-d1df299cdc58
...
replace github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring => github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.86.1
