...
get-kueue-must-gather-image:
	@REPO=quay.io/redhat-user-workloads/kueue-operator-tenant/kueue-must-gather-1-2; \
	...
	echo "quay.io/redhat-user-workloads/kueue-operator-tenant/kueue-must-gather-1-2:$$MUST_GATHER_COMMIT" > .must_gather_image && \
