...
func (c TargetConfigReconciler) sync() error {
	...
	if _, _, err := c.manageRole(kueue, "assets/kueue-operator/role-prometheus.yaml"); err != nil {
		klog.Error("unable to create role prometheus")
		return err
	}

	if _, _, err := c.manageRoleBindings(kueue, "assets/kueue-operator/rolebinding-prometheus.yaml", false); err != nil {
