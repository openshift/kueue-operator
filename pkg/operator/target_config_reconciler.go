...
func NewTargetConfigReconciler(
	...
	if c.serviceMonitorSupport {
		...
		if err := c.ensurePrometheusRBAC(); err != nil {
		...
		if err := c.ensureOperatorServiceMonitor(); err != nil {
	...
	if err := c.ensureOperatorNetworkPolicies(); err != nil {
...
func (c *TargetConfigReconciler) ensurePrometheusRBAC() error {
	...
	_, _, err = resourceapply.ApplyRole(c.ctx, c.kubeClient.RbacV1(), c.eventRecorder, role)
	if err != nil {
	...
	_, _, err = resourceapply.ApplyRoleBinding(c.ctx, c.kubeClient.RbacV1(), c.eventRecorder, roleBinding)
	if err != nil {
...
func (c *TargetConfigReconciler) ensureOperatorServiceMonitor() error {
...
func (c *TargetConfigReconciler) ensureOperatorNetworkPolicies() error {
	...
	for _, file := range files {
		...
		policy, updated, err := c.applyNetworkPolicyWithCache(want)
		if err != nil {
