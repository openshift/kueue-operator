...
func (b *KueueStatusApplyConfiguration) WithConditions(values ...*operatorv1.OperatorConditionApplyConfiguration) *KueueStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *KueueStatusApplyConfiguration) WithGenerations(values ...*operatorv1.GenerationStatusApplyConfiguration) *KueueStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
