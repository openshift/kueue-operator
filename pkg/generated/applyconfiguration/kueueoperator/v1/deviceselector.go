...
type DeviceSelectorApplyConfiguration struct {
	...
	Type *kueueoperatorv1.DeviceSelectorType `json:"type,omitempty"`
...
func (b *DeviceSelectorApplyConfiguration) WithType(value kueueoperatorv1.DeviceSelectorType) *DeviceSelectorApplyConfiguration {
	b.Type = &value
	return b
}
