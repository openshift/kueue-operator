...
type KueueConfigurationApplyConfiguration struct {
	...
	QueueLabelPolicy     *QueueLabelPolicyApplyConfiguration     `json:"queueLabelPolicy,omitempty"`
	GangSchedulingPolicy *GangSchedulingPolicyApplyConfiguration `json:"gangSchedulingPolicy,omitempty"`
...
func (b *KueueConfigurationApplyConfiguration) WithQueueLabelPolicy(value *QueueLabelPolicyApplyConfiguration) *KueueConfigurationApplyConfiguration {
	b.QueueLabelPolicy = value
	return b
}

// WithGangSchedulingPolicy sets the GangSchedulingPolicy field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the GangSchedulingPolicy field is set to the value of the last call.
func (b *KueueConfigurationApplyConfiguration) WithGangSchedulingPolicy(value *GangSchedulingPolicyApplyConfiguration) *KueueConfigurationApplyConfiguration {
	b.GangSchedulingPolicy = value
	return b
}
